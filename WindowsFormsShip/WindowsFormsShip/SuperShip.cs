...
namespace WindowsFormsShip
{
    public class SuperShip : Ship
    {
        ...
        public string MotorsForm;
        public Color MotorsColor { private set; get; }

        public SuperShip(int maxSpeed, float weight, Color bottomColor, Color dopColor, bool secondBoard, bool lifebuoy, CountMotors countmotors, string motorsForm , Color Motorcolor) :
